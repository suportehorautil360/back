...
export class CompleteRevisaoEquipDto {
  @ApiProperty({
    description: 'Data da revisão (ISO 8601)',
    example: '2026-05-31T00:00:00.000Z',
  })
  revisionDate!: Date;

  @ApiProperty({
    description: 'Leitura (km/h) registrada na revisão',
    example: 52000,
  })
  odometerReading!: number;

  @ApiProperty({
    description: 'Mecânico ou oficina responsável',
  ...
  @ApiProperty({
    description: 'Número da nota fiscal / comprovante',
    example: 'NF-0394',
  })
